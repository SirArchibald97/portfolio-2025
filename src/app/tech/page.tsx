      ...
      <div className="space-y-20">
        <ToolsSection title="🛠️ Software">
          ...
          <Tool title="Game Development">
            ...
            my Master&apos;s degree, I have also used <b>Unreal Engine</b> and
            its blueprint system. For my own projects into Minecraft modding and
            plugin development, I have used <b>Java</b> and <b>Kotlin</b> with
            the Fabric and Paper frameworks.
          </Tool>
          <Tool title="Databases">
            I&apos;ve worked with a handful of different databases, both
            relational and document-based. I started off making projects with
            local <b>SQLite</b> databases, before moving on to <b>MySQL</b> and{' '}
        ...
        <ToolsSection title="⚙️ Hardware">
          <Tool title="Workstation">
            ...
            3600X, Nvidia RTX 4070, and 16GB of RAM. It&apos;s slightly outdated
            in 2025, but it&apos;s powerful enough for my needs. My next
            upgrades will be more memory, more storage and a new case for better
            cooling.
          </Tool>
          <Tool title='2019 MacBook Air 13"'>
            My reliable old machine I used for university, it&apos;s (somehow)
            still going fairly strong, although I&apos;m considering upgrading
            to an M chip machine soon. I use this for coding on the go.
          </Tool>
          <Tool title="Peripherals">
            ...
            upgraded my main monitor to a 27&quot; 1440p 180Hz screen. I also
            have a Kono 87 TKL keyboard, a SteelSeries Aerox 3 mouse, a basic
            USB microphone and some simple IEMs. I used to use the SteelSeries
            Arctis 7 headset but found IEMs to be far more comfortable.
          </Tool>
        </ToolsSection>
        <ToolsSection title="📝 Productivity">
          <Tool title="Notion">
            I absolutely love the Notion app, as well as Notion Calendar.
            I&apos;ve used it for all my note-taking through university and
            still use it now to manage my projects and personal life.
          </Tool>
        </ToolsSection>
      </div>
    </SimpleLayout>
